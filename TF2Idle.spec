...
a = Analysis([os.path.join(HOMEPATH,'support\\_mountzlib.py'), os.path.join(HOMEPATH,'support\\useUnicode.py'), 'tf2idle/AccountDialog.py', 'tf2idle/AccountsView.py', 'tf2idle/Config.py', 'tf2idle/DropLogView.py', 'tf2idle/GroupsDialog.py', 'tf2idle/LogEntriesDialog.py', 'tf2idle/MainWindow.py', 'tf2idle/Sandboxie.py', 'tf2idle/SettingsDialog.py', 'tf2idle/TF2Idle.py', 'tf2idle/Version.py'],
             pathex=[os.getcwd()])
pyz = PYZ(a.pure)
